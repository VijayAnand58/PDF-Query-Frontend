...
export default function LearnMorePage() {
  const steps = [
    ...
    {
      title: "Parsing",
      description: "Text & images are extracted using PyMuPDF for downstream processing."
    },
    {
      title: "Embedding",
      description: "Text is embedded with HuggingFace embeddings, and images are embedded with OpenAI CLIP."
    },
    {
      title: "Storage",
      description: "All embeddings are stored efficiently in ChromaDB for fast retrieval."
    },
    {
      title: "Query Processing",
      description: "LangChain + LangGraph are used to retrieve the most relevant context for the query."
    },
    {
      title: "FastAPI Backend",
      description: "Handles the logic and serves the processed results to the frontend."
    },
    {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center px-6 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl w-full">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="font-bold text-center">Our Process Explained</CardTitle>
          </CardHeader>
          <CardContent>
          ...
          {steps.map((step, idx) => (
            <div key={idx} >
              ...
              <div className="font-semibold text-gray-600">{step.description}</div>
            </div>
          ))}
        </div>
            {/* </ScrollArea> */}
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionItem value="item-4">
              <AccordionTrigger>Is my Data Private? </AccordionTrigger>
                <AccordionContent>
                We delete all data you upload to us immediately after you logout.
                No Info is stored after logout.
              </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
